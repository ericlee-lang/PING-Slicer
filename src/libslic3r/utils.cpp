...
void set_log_path_and_level(const std::string& file, unsigned int level)
{
	...
	//BBS log file at C:\\Users\\[yourname]\\AppData\\Roaming\\PING Slicer\\log\\[log_filename].log
...
{
	// PING(2026-06-10)：Moonraker 依「generated by <名> <版> on <日期>」識別切片器，
	...
	return std::string("OrcaSlicer 2.3.2 (") + app_name + " " + SoftFever_VERSION + ")";
}
