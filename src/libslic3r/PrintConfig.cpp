...
void PrintConfigDef::init_fff_params()
{
    ...
    def->tooltip = L(
        ...
        "set appropriately. PING Slicer ensures that adaptive_bed_mesh_min/adaptive_bed_mesh_max values do not exceed these min/max "
    ...
    */
    ...
    def->tooltip = L("After a tool change, the exact position of the newly loaded filament inside "
                     ...
                     "Before purging the print head into an infill or a sacrificial object, PING Slicer will always prime "
    ...
    def->tooltip = L("Connect an infill line to an internal perimeter with a short segment of an additional perimeter. "
                     ...
                     "PING Slicer tries to connect two close infill lines to a short perimeter segment. If no such perimeter segment "
    ...
    def->tooltip = L("PING Slicer can upload G-code files to a printer host. This field must contain "
    ...
    def->tooltip = L("If you want to process the output G-code through custom scripts, "
                   ...
                   "and they can access the PING Slicer config settings by reading environment variables.");
    def->gui_flags = "serialized";
    def->multiline = true;
    def->full_width = true;
    def->height = 6;
...
CLIMiscConfigDef::CLIMiscConfigDef()
{
    ...
    def->tooltip = L("This version of PING Slicer may not understand configurations produced by the newest PING Slicer versions. "
                     "For example, newer PING Slicer may extend the list of supported firmware flavors. One may decide to "
    ...
    def->tooltip = L("If enabled, the command line arguments are sent to an existing instance of GUI PING Slicer, "
                     "or an existing PING Slicer window is activated. "
...
ReadWriteSlicingStatesConfigDef::ReadWriteSlicingStatesConfigDef()
{
    ...
    def->tooltip = L("Position of the extruder at the beginning of the custom G-code block. If the custom G-code travels somewhere else, "
                     "it should write to this variable so PING Slicer knows where it travels from when it gets control back.");
    ...
    def->tooltip = L("Retraction state at the beginning of the custom G-code block. If the custom G-code moves the extruder axis, "
                     "it should write to this variable so PING Slicer de-retracts correctly when it gets control back.");
