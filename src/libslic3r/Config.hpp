...
// When parsing a configuration value, if the old_value is not understood by this PING Slicer version,
// it is being substituted with some default value that this PING Slicer could work with.
