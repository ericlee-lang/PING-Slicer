    ...
    : DPIDialog(static_cast<wxWindow*>(wxGetApp().mainframe), wxID_ANY, _L("Network plug-in update"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    operation_tips = new ::Label(this, Label::Body_12, _L("Click OK to update the Network plug-in when PING Slicer launches next time."), LB_AUTO_WRAP);
...
UpdateVersionDialog::UpdateVersionDialog(wxWindow *parent)
    : DPIDialog(parent, wxID_ANY, _L("New version of PING Slicer"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX | wxRESIZE_BORDER)
{
    SetBackgroundColour(*wxWHITE);
...
void ConfirmBeforeSendDialog::edit_cancel_button_txt(const wxString& txt, bool switch_green)
{
    ...
    if (switch_green)
    {
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(200, 66, 18), StateColor::Pressed),
                                std::pair<wxColour, int>(wxColour(242, 108, 61), StateColor::Hovered),
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    comfirm_before_enter_text = _L("1. Please confirm PING Slicer and your printer are in the same LAN.");
    ...
    m_test_right_msg->SetForegroundColour(wxColour(242, 108, 61));
