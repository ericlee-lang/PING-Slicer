...
static const wxColour BUTTON_HOVER_COL   = wxColour(234, 78, 22);
...
static const wxColour STAGE_TEXT_COL      = wxColour(234, 78, 22);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(234, 78, 22));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(234, 78, 22));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(234, 78, 22));
        });
...
wxBoxSizer* StatusBasePanel::create_filament_group(wxWindow* parent)
{
    ...
    m_title_filament_loading->SetForegroundColour(wxColour(200, 66, 18));
