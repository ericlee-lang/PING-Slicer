    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
   ...
   // m_sizer_main->Add(m_basic_panel, 0, wxEXPAND | wxLEFT | wxRIGHT, FromDIP(15));
    ...
    {//new content//tip confirm ok button
        ...
        m_more_setting_tips->SetForegroundColour(wxColour(200, 66, 18));
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(200, 66, 18), StateColor::Pressed), std::pair<wxColour, int>(wxColour(38, 166, 154), StateColor::Hovered),
