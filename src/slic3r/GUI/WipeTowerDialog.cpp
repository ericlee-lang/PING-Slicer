...
wxString WipingDialog::BuildTextObjStr(bool multi_language)
{
    ...
    if (multi_language) {
        auto_flush_tip = _L("PING Slicer would re-calculate your flushing volumes everytime the filaments color changed or filaments changed. You could disable the auto-calculate in PING Slicer > Preferences");
        ...
        auto_flush_tip = "PING Slicer would re-calculate your flushing volumes everytime the filaments color changed or filaments changed. You could disable the auto-calculate in PING Slicer > Preferences";
