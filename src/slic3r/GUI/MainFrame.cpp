...
*/
    ...
    case GUI_App::EAppMode::Editor:
        ...
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("OrcaSlicer-mac_256px.ico"), wxBITMAP_TYPE_ICO), "PING Slicer");
        break;
...
void MainFrame::update_side_button_style()
{
    ...
    StateColor m_btn_bg_enable = StateColor(
        std::pair<wxColour, int>(wxColour(200, 66, 18), StateColor::Pressed),
        std::pair<wxColour, int>(wxColour(48, 221, 112), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(234, 78, 22), StateColor::Normal)
    );
...
static wxMenu* generate_help_menu()
{
    ...
    // Report a bug
    //append_menu_item(helpMenu, wxID_ANY, _L("Report Bug(TODO)"), _L("Report a bug of PING Slicer"),
    //    [](wxCommandEvent&) {
    //        //TODO
    //    });
    // Check New Version
