    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(200, 66, 18), StateColor::Pressed);
    border_color.append(wxColour(242, 108, 61), StateColor::Hovered);
    border_color.append(0xEA4E16, StateColor::Normal);
    ...
    background_color.append(wxColour(200, 66, 18), StateColor::Pressed);
    background_color.append(wxColour(242, 108, 61), StateColor::Hovered);
    background_color.append(0xEA4E16, StateColor::Normal);
