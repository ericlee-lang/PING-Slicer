...
HyperLink::HyperLink(wxWindow* parent, const wxString& label, const wxString& url, long style)
    ...
    , m_url(url)
    , m_normalColor(wxColour("#EA4E16")) // used slightly different color otherwise automatically uses ColorForDark that not visible enough
    , m_hoverColor(wxColour("#F0683A"))
{
