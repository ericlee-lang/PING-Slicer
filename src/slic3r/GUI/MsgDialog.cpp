                            ...
                            std::function<void(const wxString &)> link_callback = nullptr)
{
    ...
    if (!link_text.IsEmpty() && link_callback) {
        msg_escaped += "<span><a href=\"#\" style=\"color:rgb(234, 78, 22); text-decoration:underline;\">" + std::string(link_text.ToUTF8().data()) + "</a></span>";
    }
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3MF file version is in Beta and it is newer than the current PING Slicer version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try PING Slicer Beta, you may click to"));
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3MF file version is newer than the current PING Slicer version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Updating your PING Slicer could enable all functionality in the 3MF file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
