...
- request 多一欄 `cycle`：`{enabled, laps:"1,2"|"1,1,1,2", sizeMm, gapMm, brimMm}`（圈數預設 Eric 2026-09-08 第 4 階段裁；原 2,4／2,2,2,4 真切塔比模型本體重 3 倍）；**缺席＝關**（3MF／請求字串與舊版位元組全等）。宿主 `PhotoTileEngineRequest::cycle*` 只在開啟時寫入。
