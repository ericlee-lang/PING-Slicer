...
- 🚀 **r6 build 已發車（Eric 0714「發build」）**：三批（`c8c3e751`＋`4a3fa192`＋`cb10b456`）已 cherry-pick 上 release/v3.5.5＝`0673b585`/`92db6578`/`b5137817`＋版號 commit `34194a64`（tip、已 push）→ run **29296142180** 背景監看中。cherry-pick 時照片磚 2 機檔 DU 衝突按「release 無照片磚」原則 git rm；release 驗證全過（支撐四值/黃金不蓋/FD300 弧/FP300 弧/FP200 不在通用版/照片磚 0/py_compile）。**版號：bundle 48→49、%APPDATA% 49→50**（維持 bundle<appdata 嚴格小於＝DL1016 紅線；r5 用戶 48→49 會吃到更新）。綠了照慣例換 portable（現版＝r5，備份名照 -old-v355r5）。
